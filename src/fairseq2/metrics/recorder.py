...
_metric_formatters: Dict[str, Tuple[str, int, Callable[[Any], str]]] = {
    ...
    "accuracy":                  ("Accuracy",                        200, format_as_float),
    "code_perplexity":           ("Code Perplexity",                 210, format_as_float),
    "prob_perplexity":           ("Prob Perplexity",                 210, format_as_float),
    "temperature":               ("Temperature",                     210, format_as_float),
